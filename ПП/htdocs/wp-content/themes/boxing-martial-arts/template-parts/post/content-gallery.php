...
<?php $boxing_martial_arts_column_layout = get_theme_mod( 'boxing_martial_arts_sidebar_post_layout');
if($boxing_martial_arts_column_layout == 'four-column' || $boxing_martial_arts_column_layout == 'three-column' ){ ?>
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
      <div class="page-box">
        ...
        <div class="box-content mt-2 text-center">
          ...
          <p><?php echo esc_html(boxing_martial_arts_excerpt_function());?></p>
...
<div id="category-post">
  <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    <div class="page-box row">
      <?php $boxing_martial_arts_post_layout = get_theme_mod( 'boxing_martial_arts_post_layout','image-content');
      if($boxing_martial_arts_post_layout == 'image-content'){ ?>
      ...
      <?php }
      else if($boxing_martial_arts_post_layout == 'content-image'){ ?>
        <div class="box-content col-lg-6 col-md-12">
          <h4><a href="<?php echo esc_url( get_permalink() ); ?>" title="<?php the_title_attribute(); ?>"><?php the_title();?></a></h4>
          <div class="box-info">
            <?php $blog_archive_ordering = get_theme_mod('blog_meta_order', array('date', 'author', 'comment', 'category'));
