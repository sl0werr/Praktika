...
$wp_customize->add_panel( 'theme_option_panel',
	array(
	'title'      => __( 'Theme Options', 'boxing-club' ),
	'priority'   => 150,
...
$wp_customize->add_section('section_page_title', 
	array(    
	'title'       => __('Page Title', 'boxing-club'),
...
$wp_customize->add_control( 'theme_options[show_page_title]', array(
	'label'              => esc_html__( 'Display Page Title', 'boxing-club' ),
...
$wp_customize->add_section('section_sidebar_layout', array(    
	'title'       => __('Sidebar Layout', 'boxing-club'),
	'panel'       => 'theme_option_panel'    
));
...
$wp_customize->add_control(new boxing_club_Image_Radio_Control($wp_customize, 'theme_options[layout_options_blog]', 
	array(		
	'label' 	=> __('Blog Layout', 'boxing-club'),
...
$wp_customize->add_control(new boxing_club_Image_Radio_Control($wp_customize, 'theme_options[layout_options_archive]', 
	array(		
	'label' 	=> __('Archive Layout', 'boxing-club'),
	'section' 	=> 'section_sidebar_layout',
...
$wp_customize->add_control(new boxing_club_Image_Radio_Control($wp_customize, 'theme_options[layout_options_page]', 
	array(		
	'label' 	=> __('Page Layout', 'boxing-club'),
	'section' 	=> 'section_sidebar_layout',
...
$wp_customize->add_control(new boxing_club_Image_Radio_Control($wp_customize, 'theme_options[layout_options_single]', 
	array(		
	'label' 	=> __('Single Post Layout', 'boxing-club'),
	'section' 	=> 'section_sidebar_layout',
...
$wp_customize->add_section('section_excerpt_length', 
	array(    
	'title'       => __('Excerpt Length', 'boxing-club'),
	'panel'       => 'theme_option_panel'    
	)
);
...
$wp_customize->add_control( 'theme_options[excerpt_length]', array(
	'label'       => esc_html__( 'Excerpt Length', 'boxing-club' ),
...
$wp_customize->add_section('section_blog_setting', 
	array(    
	'title'       => __('Blog / Archive Settings', 'boxing-club'),
	'panel'       => 'theme_option_panel'    
	)
);
...
$wp_customize->add_setting( 'theme_options[your_latest_posts_title]',
	...
	'capability'        => 'edit_theme_options',
	'sanitize_callback' => 'boxing_club_sanitize_textarea_content',
	'transport'         => 'refresh',
	)
);
$wp_customize->add_control( 'theme_options[your_latest_posts_title]',
	array(
	'label'    => __( 'Blog Title', 'boxing-club' ),
...
$wp_customize->add_control( 'theme_options[readmore_text]',
	array(
	'label'    => __( 'Button Label', 'boxing-club' ),
	'section'  => 'section_blog_setting',
	'type'     => 'text',
	)
);
...
$wp_customize->add_section('section_footer', 
	array(    
	'title'       => __('Footer Setting', 'boxing-club'),
	'panel'       => 'theme_option_panel'    
	)
);
...
$wp_customize->add_control( 'theme_options[copyright_text]',
	array(
	'label'    => __( 'Copyright Text', 'boxing-club' ),
...
$wp_customize->add_control( 'theme_options[enable_frontpage_content]', array(
	'label'       	=> __( 'Enable Content', 'boxing-club' ),
	'description' 	=> __( 'Click to enable content on static front page only.', 'boxing-club' ),
...
$wp_customize->add_control( 'theme_options[enable_frontpage_content]', array(
	'label'       	=> esc_html__( 'Enable Homepage Content', 'boxing-club' ),
	'description' 	=> esc_html__( 'Enable content on A static page.', 'boxing-club' ),
	'section'     	=> 'static_front_page',
	'type'        	=> 'checkbox',
) );
...
$wp_customize->add_control( 'theme_options[show_header_image]', array(
	'label'              => esc_html__( 'Display Header Image', 'boxing-club' ),
